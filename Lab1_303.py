...
while True:
    try:
        a_0 = int(input("Запишіть значення a_0: "))
        a_1 = int(input("Запишіть значення a_1: "))
        a_2 = int(input("Запишіть значення a_2: "))
        a_3 = int(input("Запишіть значення a_3: "))
        n = int(input("Запишіть діапазон чисел: "))
        break
...
print("\nТочка плану, що задовольняє заданому критерію оптимальності:")
for i in range(8):
    if y[i] == min(y):
